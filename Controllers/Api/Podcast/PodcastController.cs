...
namespace ElicitPodcast.Controllers.Api.Podcast
{
    ...
    public class PodcastController : ApiController
    {
        ...
        public IHttpActionResult GetAll()
        {
            try
            {
                return Ok(new ItemsResponse<ElicitPodcast.Services.Podcast.ElicitPodcast>
                {
        ...
        //    try
        //    {
        //        ItemsResponse<Podcast> response = new ItemsResponse<Project>
        //        {
        //            Items = _podcastService.ReadById(id)
        //        };
        //        return Ok(response);
        //    }
        //    catch (Exception ex)
